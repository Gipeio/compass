...
// Use the canonical logo SVG (imported as raw string by Vite), resized for the boot display
const PIXEL_LOGO_SVG = logoSvgRaw
  .replace('width="136"', 'width="102"')
  .replace('height="112"', 'height="84"');
...
export async function showBoot() {
  ...
  pixelWrap.innerHTML = PIXEL_LOGO_SVG;
